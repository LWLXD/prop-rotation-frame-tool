...
export const defaultPrompt =
  "Keep the same prop appearance as the main image. Preserve the original color, simplified material, rounded bevels, thickness, soft surface highlights, proportions, and overall stylized 3D casual game prop icon style. The visual style should feel like a polished Western cartoon mobile game icon: clean chunky shapes, saturated friendly colors, smooth toy-like surfaces, soft painted highlights, and simple readable shading. Avoid photorealism, cinematic lighting, PBR realism, metallic/glass/stone material complexity, scratches, grime, heavy reflections, and overly detailed texture. Use a clean simple background and stable lighting. The video should look like the same object rotating, not a redesigned or photorealistic object. For horizontal rotation, make the prop complete exactly one full 360-degree yaw turn at constant speed: 0% original main view, 25% side view, 50% inferred back view, 75% opposite side view, and 100% back to the original main view for a seamless loop. Do not make it wobble, rock back and forth, pause, stop at half rotation, or jump between a few static angles. If rough front, side, or back sketches are provided, use them only to infer structure and hidden details while keeping the final rendered appearance anchored to the main image and the same cartoon icon material on unseen sides.";
